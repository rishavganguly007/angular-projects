...
export class ProfileComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this._cservice.getCustomer(this.username, this.password)
                  .subscribe(data => {this.customer = data; 
                    ...
                    this.customer_obj = this.customer; }, error => console.log(error));
                    //console.log("onInit"+ this.username)
                    this.initialiseServiceCustomer(this.username, this.password);
    
  }
  loggerCustomer = {} as Customer
  initialiseServiceCustomer(username: string, password:string): void{
    
     
    this._cservice.getCustomer(username, password).subscribe(data => {this.loggerCustomer = data;}, error => console.log(error)); 
    console.log("profile logger", username)
    this._cservice.loggedCustomer.username = username;
    this._cservice.loggedCustomer.password = password;
  ...
  /*.........................................Profile......................................................*/
  deleteCustomer() {  
    this._cservice.deleteCustomer().subscribe(data => { console.log(data); 
